...
export class EC2InstanceSystemChecksAlarmAnalyzer extends BaseAnalyzer {
    ...
    analyze(params: any, fullReport?: any): any {
        ...
        const ec2_instance_system_checks_alarm: CheckAnalysisResult = { type: CheckAnalysisType.OperationalExcellence };
        ec2_instance_system_checks_alarm.what = "Are alarms are enabled for EC2 instance System checks?";
        ec2_instance_system_checks_alarm.why = "It is important to set alarms for EC2 systems checks as otherwise suddenly your applications might be down."
        ec2_instance_system_checks_alarm.recommendation = "Recommended to set alarm for EC2  system checks to take appropriative action.";
        ...
        for (let region in allInstances) {
            ...
            for (let instance of regionInstances) {
                ...
                if(instance.InstanceId === 'i-0bc2e15a6463a07c3') {
                    console.log(instanceAlarms);
                }
        ...
        ec2_instance_system_checks_alarm.regions = allRegionsAnalysis;
        return { ec2_instance_system_checks_alarm };
    }
