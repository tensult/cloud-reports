...
export class EC2InstanceCPUUtilizationAlarmAnalyzer extends BaseAnalyzer {
    ...
    analyze(params: any, fullReport?: any): any {
        ...
        ec2_instance_cpu_utilization_alarm.why = "It is important to set alarms for EC2 CPU utilization as when utilization is high application performance will be degraded."
