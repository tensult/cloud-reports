...
export class BucketLifeCycleRulesAnalyzer extends BaseAnalyzer {
    ...
    analyze(params: any): any {
        ...
        const bucket_life_cycle_rules_used: CheckAnalysisResult = { type: CheckAnalysisType.CostOptimization };
        bucket_life_cycle_rules_used.what = "Are S3 Bucket Life Cycle rules used?";
        bucket_life_cycle_rules_used.why = "Bucket life cycle rules helps us to manage the S3 object storage by either transferring objects to cheaper storage class or deleting them."
        ...
        for (let bucketName in allBucketLifeCycleRules) {
