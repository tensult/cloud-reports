...
export class DnsQueryLogsConfigAnalyzer extends BaseAnalyzer {
    ...
    public checks_recommendation : string = "It is recommended to enable query logs for all hosted zones.";
    public checks_name : string = "HostedZone";
    public analyze(params: any): any {
        ...
        dns_query_logs_enabled.recommendation = this.checks_recommendation;
        ...
        for (const hostedZone of allHostedZones) {
            ...
            hosted_analysis.resourceSummary = {
                name: this.checks_name, value: hostedZone.Name,
            };
