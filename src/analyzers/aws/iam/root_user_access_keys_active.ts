...
export class RootUserAccessKeysActiveAnalyzer extends BaseAnalyzer {
    ...
    public checks_recommendation : string = "Recommended to delete and never user root user access keys";
    ...
    public analyze(params: any, fullReport?: any): any {
        ...
        root_user_access_keys_active.recommendation = this.checks_recommendation;
