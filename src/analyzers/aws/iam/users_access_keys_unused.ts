...
export class UsersAccessKeysUnusedAnalyzer extends BaseAnalyzer {
    ...
    analyze(params: any, fullReport?: any): any {
        ...
        const users_access_keys_unused: CheckAnalysisResult = { type: CheckAnalysisType.Security };
        ...
        userCredentials.forEach((credential) => {
            let user_access_keys_unused: ResourceAnalysisResult = {};
            ...
            let access_key_1_used = this.isUserAccessKeysActivelyUsed(credential.access_key_1_last_used_date);
            let access_key_2_used = this.isUserAccessKeysActivelyUsed(credential.access_key_2_last_used_date);

            if (credential.access_key_1_active === 'true') {
                let user_access_key1_unused: ResourceAnalysisResult = Object.assign({}, user_access_keys_unused);
            ...
            if (credential.access_key_2_active === 'true') {
                let user_access_key2_unused: ResourceAnalysisResult = Object.assign({}, user_access_keys_unused);;
