...
export class AdminCountAnalyzer extends BaseAnalyzer {
    ...
    analyze(params: any, fullReport?: any): any {
        ...
        const admin_count: CheckAnalysisResult = { type: CheckAnalysisType.OperationalExcellence };
    ...
    private getAdminGroups(group_policies: any) {
        ...
        for (let group_name in group_policies) {
            let adminPolicies = group_policies[group_name].filter((group_policy) => {
    ...
    private getAdminsFromUsers(user_policies: any) {
        ...
        for (let user_name in user_policies) {
            let adminPolicies = user_policies[user_name].filter((user_policy) => {
