            ...
            try {
                ...
                while (fetchPending) {
                    const discoveredResourcesResponse:
                        ...
                        await configservice.listDiscoveredResources
                            ({ resourceType: "AWS::EC2::Instance" }).promise();
                    discovered_resources[region] =
                        discovered_resources[region].concat(discoveredResourcesResponse.resourceIdentifiers);
                    await CommonUtil.wait(200);
                    Token = discoveredResourcesResponse.nextToken;
